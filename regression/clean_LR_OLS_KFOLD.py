...
# @Date:   2020-09-24T14:19:36-04:00
# @Email:  krb0073@mix.wvu.edu
# @Filename: clean_LR_OLS_KFOLD.py
# @Last modified by:   kbillings
# @Last modified time: 2020-11-13T09:24:38-05:00
...
for combo in list(mods['combo']):
    print(combo)
    title = str(path) + 'Clean_Kfold10precent_OLS_' +"".join(combo) + ".png"
