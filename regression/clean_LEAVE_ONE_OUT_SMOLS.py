...
# @Date:   2020-10-12T18:18:30-04:00
# @Email:  krb0073@mix.wvu.edu
# @Filename: clean_LEAVE_ONE_OUT_SMOLS.py
# @Last modified by:   kbillings
# @Last modified time: 2020-10-12T18:21:33-04:00
# @Author: Kyle Billings <kbillings>
# @Date:   2020-08-20T14:07:55-04:00
# @Email:  krb0073@mix.wvu.edu
# @Filename: LR_LOOCV_SMOLS.py
# @Last modified by:   kbillings
# @Last modified time: 2020-10-12T18:21:33-04:00
import sys
import numpy as np
...
for combo in list(mods["combo"]):
    title = str(path) +"clean_Leave_one_out_Test_set" + "".join(combo) + ".png"
