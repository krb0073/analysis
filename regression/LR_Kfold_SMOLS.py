...
# @Date:   2020-07-27T12:04:18-04:00
# @Email:  krb0073@mix.wvu.edu
# @Filename: LR_Kfold_SMOLS.py
# @Last modified by:   kbillings
# @Last modified time: 2020-09-23T17:27:37-04:00
import sys
import numpy as np
import os
...
for i in range(1,5):
    mod  = Kfold_smOLS_10precent(allDF,Ys,i,metric="MSE")
    mods.append(mod)
mods = pd.DataFrame(mods)
for combo in list(mods['combo']):
    print(combo)
    title = str(path) + 'Kfold10precent_OLS_' +"".join(combo) + ".png"
