...
at random points in a given space this verson follows 
https://github.com/GrossfieldLab/loos/blob/main/Packages/OptimalMembraneGenerator/add_molecules.py
"""
import numpy as np
...
# varables that i define befor the loops
